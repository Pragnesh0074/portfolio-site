    ...
    return (
        <div className='mx-10 md:ml-0 flex flex-col md:flex-row justify-center'>
            <div className='leftSubBlock flex flex-col' style={{color:'white'}}>
                ...
                <span className="text-[#c778dd]">I'm Pragnesh Vagadiya,</span>
                    <span className="text-[#ffffff]"> and I bring ideas to life<br/> through the magic of </span>
                ...
                <p className="mt-5 mr-0 md:mr-10 [font-family:'Fira_Code-Regular',Helvetica] font-normal text-gray text-[16px]">
                    <span className='text-[20px]'>
                        Crafts a responsive mobile application and websites <br/> where technologies meet creativity
                    </span>
                </p>
                <div className='mt-10'>
